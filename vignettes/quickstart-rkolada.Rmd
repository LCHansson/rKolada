...
vignette: >
  %\VignetteIndexEntry{Quick start guide to rKoada}
...
munic <- get_municipality(cache = TRUE)
```
...
2. `municipality`: One or a vector of several municipality IDs or municipality group IDs
